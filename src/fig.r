...
for (j in list1) {
  eval(parse(
    text = paste("base$", j, " = dexpd(NA*base$one, base$", j , ", 2012)" , sep = "")
  ))
}
...
for (j in list1) {
  eval(parse(
    text = paste("base$", j, " = dexpd(base$", j , ", NA*base$one, 2050)" , sep = "")
  ))
}
...
for (j in list1) {
  eval(parse(text = paste(
    "base$", j, "_RP = base$", j , "/base$M_GDP*100" , sep = ""
  )))
}
...
listx = cbind(
  ...
  base$M_GDP_R_GR_RP,
  base$M_GDP_PC_GR_RP,
  base$M_GDP_R_PC_GR_RP,
  base$M_PGDP_GR_RP,
  base$M_CPI_GR_RP,
  base$M_MARKET_RATE_RP,
  base$M_BOND_RATE_RP,
  base$F_FB,
  base$F_PRB,
  base$F_FI,
