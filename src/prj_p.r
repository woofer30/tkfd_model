...
base$P_RNWAGE_H16 = dexpd(base$P_RNWAGE_H16,
                          base$M_WAGE/as.numeric(base$M_WAGE["2004"])-1,
                          2012)
##被保険者数の計算
base$P_NPOP_NI = base$P_NPOP_NI_KOSEI + base$P_NPOP_NI_KOKKA + base$P_NPOP_NI_CHIHOU + base$P_NPOP_NI_SHIGAKU

base$P_NPOP_SAN = dexpd2(base$P_NPOP_SAN,
                        base$P_NPOP_SAN_KOSEI + base$P_NPOP_SAN_KOKKA + base$P_NPOP_SAN_CHIHOU + base$P_NPOP_SAN_SHIGAKU,
                        1989)

##被保険者数変化率の計算
base$P_RNPOP_P = dexpd(base$P_RNPOP_P,
                       diff(base$P_NPOP_ICHI+base$P_NPOP_NI+base$P_NPOP_SAN)/(base$P_NPOP_ICHI+base$P_NPOP_NI+base$P_NPOP_SAN),
                       2008)
...
for(m in 2013:P_SLIDE_WORK_END){
  base$P_WAGE_GR_MACRO_WORK[paste(m)]  = ifelse( as.numeric(-base$P_ARNPOP_P[paste(m)]+0.003) < as.numeric(base$M_WAGE_GR[paste(m-1)]), 
                                            base$M_WAGE_GR[paste(m-1)]+as.numeric(base$P_ARNPOP_P[paste(m)]-0.003),
                                            ifelse(as.numeric(base$M_WAGE_GR[paste(m-1)]) > 0,0,
                                                    base$M_WAGE_GR[paste(m-1)])
                                            )
}

for(m in 2013:P_SLIDE_KISO_END){
  base$P_WAGE_GR_MACRO_KISO[paste(m)]  = ifelse( as.numeric(-base$P_ARNPOP_P[paste(m)]+0.003) < as.numeric(base$M_WAGE_GR[paste(m-1)]), 
                                            base$M_WAGE_GR[paste(m-1)]+as.numeric(base$P_ARNPOP_P[paste(m)]-0.003),
                                            ifelse(as.numeric(base$M_WAGE_GR[paste(m-1)]) > 0,0,
                                                    base$M_WAGE_GR[paste(m-1)])
                                            )
...
base$P_EXP_CHIHOU =	base$P_EXP_CHIHOU_TAISHOKU+base$P_EXP_CHIHOU_SHOGAI+base$P_EXP_CHIHOU_IZOKU

base$P_EXP_SHIGAKU =	base$P_EXP_SHIGAKU_TAISHOKU+base$P_EXP_SHIGAKU_SHOGAI+base$P_EXP_SHIGAKU_IZOKU

base$P_NEXP_WORK =	(base$P_EXP_KOSEI+base$P_EXP_KOKKA+base$P_EXP_CHIHOU+base$P_EXP_SHIGAKU
                    -base$P_GRA_KOSEI-base$P_GRA_KOKKA-base$P_GRA_CHIHOU-base$P_GRA_SHIGAKU)
...
base$P_NEXP_WORK = dexpd(base$P_NEXP_WORK, 
                         exp(  -6.4159025 + 0.5247495*log(base$P_NPOP_JUKYU_WORK)+ 0.8864705*log(base$P_WAGE_A)),
                         2013)
...
base$P_EXP_KISO =  dexpd(base$P_EXP_KISO,
                            exp(-10.4560219952666 + 0.946088920842381*log(base$P_NPOP_JUKYU_P) + 0.785966661933845*log(base$P_WAGE_KISO)),
                            2013)
...
base$P_KENSHO_EXCEPT_LIAB_KOKU = base$P_KENSHO_LIAB_KOKU - base$P_KENSHO_EXP_KOKU_KISO*0.5
...
base$P_EXP_KOKU_KISO =  dexpd(base$P_EXP_KOKU_KISO,
                              (base$P_EXP_KISO-base$P_EXCEPT_LIAB)/(base$P_NPOP_ICHI_SANTEI+base$P_NPOP_NI+base$P_NPOP_SAN)*base$P_NPOP_ICHI_SANTEI,
                              2013)
...
base$P_EXP_WORK_KISO =	dexpd(base$P_EXP_WORK_KISO,
                             (base$P_EXP_KISO-base$P_EXCEPT_LIAB)/(base$P_NPOP_ICHI_SANTEI+base$P_NPOP_NI+base$P_NPOP_SAN)*(base$P_NPOP_NI+base$P_NPOP_SAN),
                             2013)
...
base$P_REV_KOKU = dexpd(base$P_REV_KOKU,
                        (base$P_NPOP_ICHI*1000*(1-base$P_RMENJO)*base$P_RNOHU)*base$P_MPRE_KOKU*(1+base$P_RNWAGE_H16)*12,
                        2013)
...
base$P_REV_WORK = base$P_REV_KOSEI+base$P_REV_KOKKA+base$P_REV_CHIHOU+base$P_REV_SHIGAKU
...
##国民年金その他収入
base$P_R_OTH_KOKU = dexpd (base$P_R_OTH_KOKU, base$P_KENSHO_REV_OTH_KOKU/base$P_KENSHO_REV_KOKU,2013)
...
base$P_R_OTH_WORK = dexpd (base$P_R_OTH_WORK, base$P_KENSHO_REV_OTH_WORK/base$P_KENSHO_REV_WORK,2013)
...
for(i in 2014:2110){
        base$P_INCOME_KOKU[paste(i)] = (as.numeric(base$P_RESERVE_KOKU[paste(i-1)])+
                                                             as.numeric(base$P_BA_KOKU[paste(i)])*0.5)*as.numeric(base$P_TOVER[paste(i)])
...
for(i in 2014:2110){
  base$P_INCOME_WORK[paste(i)] = (as.numeric(base$P_RESERVE_WORK[paste(i-1)])+
                                                             as.numeric(base$P_BA_WORK[paste(i)])*0.5)*as.numeric(base$P_TOVER[paste(i)])
