...
##年齢別国民医療費（十億円）
base$H_HM_EXP_0_14 = dexpd(
  base$H_HM_EXP_0_14,
  base$H_HM_EXP_PC_0_14 * base$M_POP_0_14 * (((
    1 + base$M_GDP_R_PC_GR
  ) ^ base$H_RUR - 1) * H_ELA_0_14 + 1) / 1000
  ,
  2013
)
base$H_HM_EXP_15_44 = dexpd(
  base$H_HM_EXP_15_44,
  base$H_HM_EXP_PC_15_44 * base$M_POP_15_44 * (((
    1 + base$M_GDP_R_PC_GR
  ) ^ base$H_RUR - 1) * H_ELA_15_44 + 1) / 1000
  ,
  2013
)
base$H_HM_EXP_45_64 = dexpd(
  base$H_HM_EXP_45_64,
  base$H_HM_EXP_PC_45_64 * base$M_POP_45_64 * (((
    1 + base$M_GDP_R_PC_GR
  ) ^ base$H_RUR - 1) * H_ELA_45_64 + 1) / 1000
  ,
  2013
)
base$H_HM_EXP_65_74 = dexpd(
  base$H_HM_EXP_65_74,
  base$H_HM_EXP_PC_65_74 * base$M_POP_65_74 * (((
    1 + base$M_GDP_R_PC_GR
  ) ^ base$H_RUR - 1) * H_ELA_65_74 + 1) / 1000
  ,
  2013
)
base$H_HM_EXP_75_o = dexpd(
  base$H_HM_EXP_75_o,
  base$H_HM_EXP_PC_75_o * base$M_POP_75_o * (((
    1 + base$M_GDP_R_PC_GR
  ) ^ base$H_RUR - 1) * H_ELA_75_o + 1) / 1000
  ,
  2013
)
...
##国民医療費（十億円）
base$H_HM_EXP = base$H_HM_EXP_0_14 + base$H_HM_EXP_15_44 + base$H_HM_EXP_45_64 +
  base$H_HM_EXP_65_74 + base$H_HM_EXP_75_o
...
base$H_HM_POP_ins = base$H_HM_POP_KOUKI + base$H_HM_POP_KOKUHO + base$H_HM_POP_KENPO +
  base$H_HM_POP_KUMIAI + base$H_HM_POP_KYOSAI
...
##年齢別保険加入者総数（千人）
base$H_HM_POP_ins_0_14 = base$H_HM_POP_KOKUHO_0_14 + base$H_HM_POP_KENPO_0_14 +
  base$H_HM_POP_KUMIAI_0_14 + base$H_HM_POP_KYOSAI_0_14
base$H_HM_POP_ins_15_44 = base$H_HM_POP_KOKUHO_15_44 + base$H_HM_POP_KENPO_15_44 +
  base$H_HM_POP_KUMIAI_15_44 + base$H_HM_POP_KYOSAI_15_44
base$H_HM_POP_ins_45_64 = base$H_HM_POP_KOKUHO_45_64 + base$H_HM_POP_KENPO_45_64 +
  base$H_HM_POP_KUMIAI_45_64 + base$H_HM_POP_KYOSAI_45_64
base$H_HM_POP_ins_65_74 = base$H_HM_POP_KOKUHO_65_74 + base$H_HM_POP_KENPO_65_74 +
  base$H_HM_POP_KUMIAI_65_74 + base$H_HM_POP_KYOSAI_65_74
...
base$H_HM_EXP_KOKUHO = base$H_HM_EXP_KOKUHO_0_14 + base$H_HM_EXP_KOKUHO_15_44 +
  base$H_HM_EXP_KOKUHO_45_64 + base$H_HM_EXP_KOKUHO_65_74
...
base$H_HM_EXP_KUMIAI_65_74 = base$H_HM_POP_KUMIAI_65_74 / base$H_HM_POP_ins_65_74 *
  base$H_HM_de_EXP_65_74
base$H_HM_EXP_KUMIAI = base$H_HM_EXP_KUMIAI_0_14 + base$H_HM_EXP_KUMIAI_15_44 +
  base$H_HM_EXP_KUMIAI_45_64 + base$H_HM_EXP_KUMIAI_65_74
...
base$H_HM_EXP_KYOSAI_65_74 = base$H_HM_POP_KYOSAI_65_74 / base$H_HM_POP_ins_65_74 *
  base$H_HM_de_EXP_65_74
base$H_HM_EXP_KYOSAI = base$H_HM_EXP_KYOSAI_0_14 + base$H_HM_EXP_KYOSAI_15_44 +
  base$H_HM_EXP_KYOSAI_45_64 + base$H_HM_EXP_KYOSAI_65_74
...
base$H_HC_POP_40_64 = dexpd(base$H_HC_POP_40_64,
                            base$M_POP_40_64 * base$H_HC_CER_Rate_40_64,
                            2013)
base$H_HC_POP_65_74 = dexpd(base$H_HC_POP_65_74,
                            base$M_POP_65_74 * base$H_HC_CER_Rate_65_74,
                            2013)
base$H_HC_POP_75_o = dexpd(base$H_HC_POP_75_o,
                           base$M_POP_75_o * base$H_HC_CER_Rate_75_o,
                           2013)
...
##各介護サービスの給付費
base$H_HC_EXP_SHISETU = dexpd(
  base$H_HC_EXP_SHISETU,
  base$H_HC_POP_D_SHISETU * base$H_HC_EXP_SHISETU_PC *
    (((
      1 + base$M_GDP_R_PC_GR
    ) ^ base$H_RUR - 1) * base$H_HC_ELA_SHISETU + 1),
  2013
)
base$H_HC_EXP_KYOTAKU = dexpd(
  base$H_HC_EXP_KYOTAKU,
  base$H_HC_POP_D_KYOTAKU * base$H_HC_EXP_KYOTAKU_PC *
    (((
      1 + base$M_GDP_R_PC_GR
    ) ^ base$H_RUR - 1) * base$H_HC_ELA_KYOTAKU + 1),
  2013
)
base$H_HC_EXP_TIIKI = dexpd(
  base$H_HC_EXP_TIIKI,
  base$H_HC_POP_D_TIIKI * base$H_HC_EXP_TIIKI_PC *
    (((
      1 + base$M_GDP_R_PC_GR
    ) ^ base$H_RUR - 1) * base$H_HC_ELA_TIIKI + 1),
  2013
)
