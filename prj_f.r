...
base$F_SHS_FI_RGDP_RES=(base$H_HM_EXP_pub+base$H_HC_EXP_pub+base$P_LIAB_KOKU+base$P_LIAB_WORK)/base$M_GDP


base$F_SHS_FI_RGDP=dexpd(base$F_SHS_FI/base$M_GDP, 
				as.numeric(base$F_SHS_FI_RGDP[index(base)==2013]) 
				+ base$F_SHS_FI_RGDP_RES - as.numeric(base$F_SHS_FI_RGDP_RES[index(base)==2013]) ,2013)
base$F_SHS_FI = base$F_SHS_FI_RGDP*base$M_GDP


##社会保障及び利払い費以外の政府支出（対GDP)##
base$F_SNS_FI_RGDP=base$F_SNS_FI/base$M_GDP
base$F_SNS_FI = dexpd(base$F_SNS_FI_RGDP,base$F_SNS_FI_RGDP[index(base)==2013],2013)*base$M_GDP



##消費税収（対GDP）##
base$F_XTAX_IW_RGDP  = dexpd(base$F_XTAX_IW/base$M_GDP,
	base$F_XTAX_R*as.numeric((base$F_XTAX_IW[index(base)==2013]/base$M_GDP[index(base)==2013])/base$F_XTAX_R[index(base)==2013])
	+base$F_DLT*as.numeric((base$F_XTAX_IW[index(base)==2013]/base$M_GDP[index(base)==2013])/base$F_XTAX_R[index(base)==2013])*(1-1/5.4),
	2013)
base$F_XTAX_IW       = base$F_XTAX_IW_RGDP*base$M_GDP


##消費以外の税収（対GDP）##
base$F_STAX_IW_RGDP = dexpd(base$F_STAX_IW/base$M_GDP,as.numeric(base$F_STAX_IW[index(base)==2013]/base$M_GDP[index(base)==2013]),2013)
...
base$F_SHL_IW = dexpd(base$F_SHL_IW_RGDP,base$F_SHL_IW_RGDP[index(base)==2013],2013)*base$M_GDP

##利子(受取)
base$F_RT_IW_RGDP=base$F_RT_IW/base$M_GDP
base$F_RT_IW = dexpd(base$F_RT_IW_RGDP,base$F_RT_IW_RGDP[index(base)==2013],2013)*base$M_GDP
...
base$F_SSM = acml(base$F_SSM,-base$F_PRB_PLUS_RT_IW,1+base$M_BOND_RATE-F_BOND_SPREAD,2014)
base$F_SSM_RGDP = base$F_SSM/base$M_GDP


##利子（支払)
base$F_RT_FI_RGDP= dexpd(base$F_RT_FI, (base$M_BOND_RATE-F_BOND_SPREAD)*lg2(base$F_SSM), 2013)/base$M_GDP
